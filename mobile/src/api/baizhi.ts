...
export function getNemesisCodeBaizhiLoginUrl(nemesisCodeBaseUrl: string): string {
  return `${trimBase(nemesisCodeBaseUrl)}/api/v1/users/login?redirect=&inviter_id=`;
}
