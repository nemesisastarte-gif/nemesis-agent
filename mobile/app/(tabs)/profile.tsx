...
import { BigTitle, Card, GlassTop, NemesisLogo, Pill, Row, Toast } from '@/components/ui';
    ...
    <Card style={{ padding: 16 }}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
        ...
        <View style={{ flex: 1, minWidth: 0 }}>
          <Text style={{ fontSize: 16, fontWeight: '800', color: t.tx }}>NemesisCode</Text>
    ...
    <View style={{ flex: 1, backgroundColor: t.bg }}>
      ...
      >
        ...
        <View style={{ paddingHorizontal: spacing.pad, paddingTop: 12, gap: spacing.gap }}>
          ...
          <Text style={{ textAlign: 'center', color: t.tx3, fontSize: 12, marginTop: 4 }}>Building with NemesisCode</Text>
        </View>
      </ScrollView>
