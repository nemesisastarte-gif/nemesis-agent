...
func (_u *TeamMemberUpdate) SetRole(v consts.TeamMemberRole) *TeamMemberUpdate {
	_u.mutation.SetRole(v)
	return _u
}

// SetNillableRole sets the "role" field if the given value is not nil.
func (_u *TeamMemberUpdate) SetNillableRole(v *consts.TeamMemberRole) *TeamMemberUpdate {
	if v != nil {
		_u.SetRole(*v)
	}
	return _u
...
func (_u *TeamMemberUpdate) check() error {
	if _u.mutation.TeamCleared() && len(_u.mutation.TeamIDs()) > 0 {
		return errors.New(`db: clearing a required unique edge "TeamMember.team"`)
	}
	if _u.mutation.UserCleared() && len(_u.mutation.UserIDs()) > 0 {
		return errors.New(`db: clearing a required unique edge "TeamMember.user"`)
	}
	return nil
}

// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (_u *TeamMemberUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *TeamMemberUpdate {
...
// SetRole sets the "role" field.
func (_u *TeamMemberUpdateOne) SetRole(v consts.TeamMemberRole) *TeamMemberUpdateOne {
	_u.mutation.SetRole(v)
	return _u
}

// SetNillableRole sets the "role" field if the given value is not nil.
func (_u *TeamMemberUpdateOne) SetNillableRole(v *consts.TeamMemberRole) *TeamMemberUpdateOne {
	if v != nil {
		_u.SetRole(*v)
	}
	return _u
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (_u *TeamMemberUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *TeamMemberUpdateOne {
	_u.modifiers = append(_u.modifiers, modifiers...)
	return _u
}
...
func (_u *TeamMemberUpdateOne) sqlSave(ctx context.Context) (_node *TeamMember, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`db: missing "TeamMember.id" for update`)}
	}
