...
func (_q *ProjectQuery) QueryGitIdentity() *GitIdentityQuery {
...
func (_q *ProjectQuery) QueryImage() *ImageQuery {
...
func (_q *ProjectQuery) QueryIssues() *ProjectIssueQuery {
...
func (_q *ProjectQuery) QueryCollaborators() *ProjectCollaboratorQuery {
...
func (_q *ProjectQuery) WithGitIdentity(opts ...func(*GitIdentityQuery)) *ProjectQuery {
	query := (&GitIdentityClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProjectQuery) WithImage(opts ...func(*ImageQuery)) *ProjectQuery {
	query := (&ImageClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProjectQuery) WithIssues(opts ...func(*ProjectIssueQuery)) *ProjectQuery {
	query := (&ProjectIssueClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProjectQuery) WithCollaborators(opts ...func(*ProjectCollaboratorQuery)) *ProjectQuery {
	query := (&ProjectCollaboratorClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProjectQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Project, error) {
	...
	if query := _q.withGitIdentity; query != nil {
		if err := _q.loadGitIdentity(ctx, query, nodes, nil,
			func(n *Project, e *GitIdentity) { n.Edges.GitIdentity = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withImage; query != nil {
		if err := _q.loadImage(ctx, query, nodes, nil,
			func(n *Project, e *Image) { n.Edges.Image = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withIssues; query != nil {
		if err := _q.loadIssues(ctx, query, nodes,
			func(n *Project) { n.Edges.Issues = []*ProjectIssue{} },
			func(n *Project, e *ProjectIssue) { n.Edges.Issues = append(n.Edges.Issues, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCollaborators; query != nil {
		if err := _q.loadCollaborators(ctx, query, nodes,
			func(n *Project) { n.Edges.Collaborators = []*ProjectCollaborator{} },
			func(n *Project, e *ProjectCollaborator) { n.Edges.Collaborators = append(n.Edges.Collaborators, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *ProjectQuery) loadGitIdentity(ctx context.Context, query *GitIdentityQuery, nodes []*Project, init func(*Project), assign func(*Project, *GitIdentity)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Project)
	for i := range nodes {
...
func (_q *ProjectQuery) loadImage(ctx context.Context, query *ImageQuery, nodes []*Project, init func(*Project), assign func(*Project, *Image)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Project)
	for i := range nodes {
		fk := nodes[i].ImageID
...
func (_q *ProjectQuery) loadIssues(ctx context.Context, query *ProjectIssueQuery, nodes []*Project, init func(*Project), assign func(*Project, *ProjectIssue)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(projectissue.FieldProjectID)
	}
...
func (_q *ProjectQuery) loadCollaborators(ctx context.Context, query *ProjectCollaboratorQuery, nodes []*Project, init func(*Project), assign func(*Project, *ProjectCollaborator)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Project)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(projectcollaborator.FieldProjectID)
	}
	query.Where(predicate.ProjectCollaborator(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(project.CollaboratorsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ProjectQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withGitIdentity != nil {
			_spec.Node.AddColumnOnce(project.FieldGitIdentityID)
		}
		if _q.withImage != nil {
			_spec.Node.AddColumnOnce(project.FieldImageID)
		}
	}
