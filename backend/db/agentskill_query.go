...
type AgentSkillQuery struct {
	...
	withRepo     *AgentSkillRepoQuery
	withVersions *AgentSkillVersionQuery
...
func (_q *AgentSkillQuery) QueryRepo() *AgentSkillRepoQuery {
	query := (&AgentSkillRepoClient{config: _q.config}).Query()
...
func (_q *AgentSkillQuery) QueryVersions() *AgentSkillVersionQuery {
	query := (&AgentSkillVersionClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *AgentSkillQuery) WithRepo(opts ...func(*AgentSkillRepoQuery)) *AgentSkillQuery {
	query := (&AgentSkillRepoClient{config: _q.config}).Query()
...
func (_q *AgentSkillQuery) WithVersions(opts ...func(*AgentSkillVersionQuery)) *AgentSkillQuery {
	query := (&AgentSkillVersionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(agentskill.FieldRepoID).
//		Aggregate(db.Count()).
//		Scan(ctx, &v)
...
func (_q *AgentSkillQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AgentSkill, error) {
	...
	if query := _q.withRepo; query != nil {
		if err := _q.loadRepo(ctx, query, nodes, nil,
			func(n *AgentSkill, e *AgentSkillRepo) { n.Edges.Repo = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withVersions; query != nil {
		if err := _q.loadVersions(ctx, query, nodes,
			...
			func(n *AgentSkill, e *AgentSkillVersion) { n.Edges.Versions = append(n.Edges.Versions, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AgentSkillQuery) loadRepo(ctx context.Context, query *AgentSkillRepoQuery, nodes []*AgentSkill, init func(*AgentSkill), assign func(*AgentSkill, *AgentSkillRepo)) error {
	...
	query.Where(agentskillrepo.IDIn(ids...))
...
func (_q *AgentSkillQuery) loadVersions(ctx context.Context, query *AgentSkillVersionQuery, nodes []*AgentSkill, init func(*AgentSkill), assign func(*AgentSkill, *AgentSkillVersion)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(agentskillversion.FieldResourceID)
	}
	query.Where(predicate.AgentSkillVersion(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(agentskill.VersionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *AgentSkillQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withRepo != nil {
			_spec.Node.AddColumnOnce(agentskill.FieldRepoID)
		}
	}
...
func (_q *AgentSkillQuery) ForUpdate(opts ...sql.LockOption) *AgentSkillQuery {
...
func (_q *AgentSkillQuery) ForShare(opts ...sql.LockOption) *AgentSkillQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
