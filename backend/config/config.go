...
func Init(dir string) (*Config, error) {
	...
	v.SetDefault("loki.addr", "http://nemesiscode-ai-loki:3100")
	...
	v.SetDefault("telemetry.service_name", "nemesiscode-backend")
	...
	v.SetDefault("object_storage.endpoint", "http://nemesiscode-ai-rustfs:9000")
