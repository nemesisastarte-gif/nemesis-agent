...
export function builtinTierLabel(model?: string): string | undefined {
  switch (builtinName(model)) {
    case "nemesiscode-basic":
      return "基础";
    case "nemesiscode-pro":
      return "专业";
    case "nemesiscode-ultra":
      return "旗舰";
    default:
      return undefined;
  }
...
export function groupCloudModels(models: McCloudModel[], plan?: string): McCloudModelGroup[] {
  ...
  const builtin: McCloudModelGroup[] = [
    { key: "nemesiscode-basic", label: "基础模型", badge: "免费使用", models: [] },
    { key: "nemesiscode-pro", label: "专业模型", badge: "专业会员免费", models: [] },
    { key: "nemesiscode-ultra", label: "旗舰模型", badge: "旗舰会员免费", models: [] },
  ].map((group) => ({
    ...group,
...
export function pickDefaultCloudModel(models: McCloudModel[], plan?: string): string {
  ...
  const planBuiltin = plan === "pro" ? "nemesiscode-pro" : plan === "flagship" || plan === "ultra" ? "nemesiscode-ultra" : "nemesiscode-basic";
