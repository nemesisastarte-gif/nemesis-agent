...
import { SOURCE_NEMESISCODE, type LogItem, type ModelInfo, type SessionMeta, type SessionNotice, type Usage } from "./types";
...
export function ModelPicker({
  ...
  const memberSections = activeTab === SOURCE_NEMESISCODE ? groupMemberSections(tabItems) : null;
