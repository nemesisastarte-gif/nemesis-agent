...
// 收口在 useSession 句柄里;视觉对照「NemesisCode 桌面应用设计」。
...
export default function App() {
  ...
  // ===== NemesisCode 云端账号与任务 =====
  // 百智云登录只用于显式桥接授权;这里独立持有 NemesisCode 关联态。
  ...
  // 启动只恢复已有 NemesisCode 会话;离开设置页也重查,但不再自动桥接登录。
  useEffect(() => {
  ...
  useEffect(() => {
    setWindowTitle(`${windowContext} - NemesisCode`);
  }, [windowContext]);
