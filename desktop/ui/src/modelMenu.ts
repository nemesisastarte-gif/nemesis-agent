...
import { modelSourceLabel, SOURCE_BAIZHI, SOURCE_NEMESISCODE, type ModelInfo } from "./types";
...
export function modelMenuTabs(models: ModelInfo[]): ModelMenuTab[] {
  ...
  for (const m of models) {
    ...
    const label = m.source === SOURCE_NEMESISCODE ? "会员" : modelSourceLabel(m.source);
