...
import { SOURCE_BAIZHI, SOURCE_NEMESISCODE, type HostConfig, type HostModel } from "./types";
...
/** 同步条目的落盘名 = 原名 + 来源后缀(@baizhi / @nemesiscode[#配置 id])。
 *
...
/** 同步来源组整组替换(模型与 MCP、百智云与 NemesisCode 共用语义):
