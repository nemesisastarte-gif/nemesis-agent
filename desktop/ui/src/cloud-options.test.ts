...
const hosts: McCloudHost[] = [
  { id: "public_host", name: "NemesisCode", status: "online" },
...
const models: McCloudModel[] = [
  { id: "meta", model: "nemesiscode-basic", weight: 999, owner: { type: "public" } },
  { id: "basic", model: "nemesiscode-basic/claude", owner: { type: "public" } },
  { id: "pro", model: "nemesiscode-pro/gpt", owner: { type: "public" } },
  { id: "ultra", model: "nemesiscode-ultra/gemini", owner: { type: "public" } },
