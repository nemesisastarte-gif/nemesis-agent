...
// - 登录成功只报边沿(onBaizhiLoggedIn),状态刷新与 NemesisCode 桥接由宿主
//   AccountSection 统一处理。
// - NemesisCode 账号密码登录(PasswordForm)从这里导出但**不在本面板出现**:
//   入口归 NemesisCode 卡(用户报障 2026-08-06:两块账号的东西串到一块了)。
//
...
/** NemesisCode 账号密码登录(不经百智云;壳内自动 PoW)。导出给账号卡的
