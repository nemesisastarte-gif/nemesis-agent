...
///   cargo test --bin nemesiscode-desktop e2e_wsl -- --include-ignored
#[tokio::test(flavor = "multi_thread")]
...
fn upload_path_extraction_keeps_only_images() {
    let content = "读取 .nemesiscode/uploads/合同.docx 与 .nemesiscode/uploads/latest.json,\
                   截图 .nemesiscode/uploads/browser-1.png (.nemesiscode/uploads/cat.JPG) \
                   忽略 .nemesiscode/uploads/.gitignore 与重复 .nemesiscode/uploads/browser-1.png";
    assert_eq!(
        crate::driver::normalize::extract_upload_paths(content),
        [".nemesiscode/uploads/browser-1.png", ".nemesiscode/uploads/cat.JPG"]
    );
}
...
fn parse_manifest_models_tolerates_missing_model_field() {
    let models = parse_manifest_models(&json!([
        ...
        { "name": "会员别名", "source": "nemesiscode", "model": "nemesiscode-pro/deepseek-pro",
    ...
    assert_eq!(models[1].model, "nemesiscode-pro/deepseek-pro");
    assert_eq!(models[1].source, "nemesiscode");
