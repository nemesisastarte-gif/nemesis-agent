...
const BUILTIN_TASK_MODEL_OPTIONS = [
  { model: "nemesiscode-basic", labelKey: "basic", badgeKey: "basicBadge", badgeVariant: "default" as const, iconName: "gift" },
  { model: "nemesiscode-pro", labelKey: "pro", badgeKey: "proBadge", badgeVariant: "secondary" as const, iconName: "vip-1" },
  { model: "nemesiscode-ultra", labelKey: "ultra", badgeKey: "ultraBadge", badgeVariant: "secondary" as const, iconName: "vip-2" },
] as const
