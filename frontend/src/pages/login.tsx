...
import type { GithubComChaitinNemesisCodeBackendDomainTeamOIDCPublicConfigResp as DomainTeamOIDCPublicConfigResp, GithubComGoYokoWebResp } from "@/api/Api"
                      ...
                      <form onSubmit={(e) => { e.preventDefault(); handleUserLogin(); }}>
                        <FieldGroup className="gap-5">
                          <Field>
                            ...
                            <Input
                              value={userEmail}
                              placeholder="nemesiscode@example.com"
                              onChange={(e) => setUserEmail(e.target.value)}
                              id="user-email"
                              type="email"
                              required
