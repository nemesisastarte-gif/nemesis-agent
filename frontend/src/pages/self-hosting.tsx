...
const ONLINE_INSTALL_COMMAND = `bash -c "$(curl -fsSL 'https://nemesiscode-ai.com/online/install')"`;
const OFFLINE_INSTALL_COMMAND = `curl -fL -o nemesiscode-offline-linux-amd64.tgz \\
  https://nemesiscode-release.oss-cn-hangzhou.aliyuncs.com/public/offline-package/nemesiscode-offline-linux-amd64.tgz

tar -zxvf nemesiscode-offline-linux-amd64.tgz
cd nemesiscode-offline-linux-amd64/
sh install.sh`;
