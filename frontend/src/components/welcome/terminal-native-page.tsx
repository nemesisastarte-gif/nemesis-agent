...
const GITHUB_LINK = "https://github.com/teteekoue/NemesisCode/";
...
const mobileClientItems = [
  {
    ...
    href: "https://release.monkeycode-ai.com/public/mobile/app/nemesiscode-latest.apk",
    i18nKey: "android",
  },
  {
    platform: "iOS",
    icon: IconBrandApple,
    href: "https://apps.apple.com/cn/app/nemesiscode%E7%BC%96%E7%A8%8B%E5%8A%A9%E6%89%8B/id6777423440",
    i18nKey: "ios",
  },
] as const;
...
const desktopClientItems = [
  {
    ...
    href: "https://release.monkeycode-ai.com/public/desktop/NemesisCode_latest_x64-setup.exe",
    i18nKey: "windows",
  },
  {
    platform: "macOS",
    icon: IconBrandApple,
    href: "https://release.monkeycode-ai.com/public/desktop/NemesisCode_latest_universal.dmg",
    i18nKey: "macos",
  },
  {
    platform: "Linux",
    icon: IconTerminal,
    href: "https://release.monkeycode-ai.com/public/desktop/NemesisCode_latest_amd64.AppImage",
    i18nKey: "linux",
  },
] as const;
...
const compareColumns = ["NemesisCode", "Cursor", "Claude Code", "Codex"] as const;
...
function PromptLine({
  ...
  return (
    <div className={cn("text-[13px] leading-7 text-[var(--a-fg)]", className)}>
      <span className="text-[var(--a-accent)]">dev@nemesis</span>
    ...
    >
      ...
      <main className="relative z-10 pt-[88px] sm:pt-[92px]">
        ...
        >
          <div className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
            <div className="rounded-md border border-[var(--a-line)] bg-[var(--a-panel)] p-6">
              <div className="text-[10px] tracking-[0.12em] text-[var(--a-accent)]">$ nemesis deploy --self-hosted</div>
        ...
        <section className="mx-auto max-w-[1280px] px-5 pb-10 pt-6 text-center sm:px-8 sm:pb-14 sm:pt-10">
          ...
          <div className="relative">
            <div className="text-[11px] tracking-[0.12em] text-[var(--a-accent)]">┌─ START WITH NEMESISCODE ─┐</div>
