...
const githubLink = "https://github.com/teteekoue/NemesisCode";
          ...
          <div className="flex min-w-0 items-center gap-3">
            ...
            <Link to="/" className="flex min-w-0 items-center gap-3">
              <div className="flex size-11 shrink-0 items-center justify-center rounded-2xl border border-[#243329] bg-[#111814] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
                <img src="/logo-light.png" className="size-7" alt="NemesisCode Logo" />
              </div>
              <div className="min-w-0">
                <div className="truncate text-[11px] uppercase tracking-[0.26em] text-[#7cf29c]">Terminal Native</div>
                <div className="truncate text-sm font-medium text-[#e8efe9] sm:text-[15px]">NemesisCode</div>
              </div>
            </Link>
          </div>
        ...
        <div className="md:hidden flex flex-row items-center gap-2">
          <Drawer>
            ...
            <DrawerContent className={cn(isPixelPage && "border-2 border-slate-900 bg-[#fffdf8]")}>
              <DrawerHeader>
                <DrawerTitle className={cn(isPixelPage && "font-pixel text-xs text-slate-900")}>NemesisCode</DrawerTitle>
              </DrawerHeader>
          ...
          <Link to="/" className={cn("mr-6 flex flex-row items-center gap-3 text-base font-semibold cursor-pointer", isPixelPage && "text-slate-950")}>
            <img src="/logo-light.png" className={cn("size-8", isPixelPage && "border-2 border-slate-900 bg-white p-1")} alt="NemesisCode Logo" />
            <span className={cn(isPixelPage ? "font-pixel text-sm tracking-normal sm:text-base" : "text-base")}>NemesisCode</span>
          </Link>
        </div>
