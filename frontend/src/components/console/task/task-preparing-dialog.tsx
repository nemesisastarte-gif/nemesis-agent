...
import { ConstsTaskStatus, GitInChaitinNetAiNemesiscodeNemesiscodeAiEntTypesConditionType, type DomainProjectTask } from "@/api/Api"
...
export function useShouldShowPreparing(task: DomainProjectTask | null) {
  return useMemo(() => {
    ...
    if (lastCondition?.type === GitInChaitinNetAiNemesiscodeNemesiscodeAiEntTypesConditionType.ConditionTypeFailed) {
      return true
    }
