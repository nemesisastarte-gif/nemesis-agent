...
const imageAnalysisCreateTaskTitles = new Set([
  "nemesiscode-ai_NemesisCode__image_analysis_create_task",
])

const imageAnalysisGetResultTitles = new Set([
  "nemesiscode-ai_NemesisCode__image_analysis_get_result",
])
...
const toolCallRenderers: ToolCallRenderer[] = [
  {
    match: (message) => (
      ...
      && message.data.title === "nemesiscode-ai_internal__report_user_abuse"
    ),
  ...
  },
  {
    match: (message) => (
      message.data.kind === "other"
      && message.data.title === "nemesiscode-ai_NemesisCode__websearch_aisearch"
    ),
  ...
  },
  {
    match: (message) => (
      message.data.kind === "other"
      && message.data.title === "nemesiscode-ai_NemesisCode__websearch_search"
    ),
    renderTitle: internalWebsearchRender.renderTitle,
    renderDetail: internalWebsearchRender.renderDetail,
  },
  {
    match: (message) => (
      message.data.kind === "other"
      && message.data.title === "nemesiscode-ai_NemesisCode__imgsearch_search"
    ),
  ...
  },
  {
    match: (message) => (
      message.data.kind === "other"
      && message.data.title === "nemesiscode-ai_NemesisCode__image_generate_text_to_image"
    ),
    renderTitle: (message) => {
  ...
  },
  {
    match: (message) => (
      message.data.kind === "other"
      && message.data.title === "nemesiscode-ai_NemesisCode__image_generate_query_task"
    ),
