...
import type {
  GithubComChaitinNemesisCodeBackendDomainCreateUserMCPUpstreamReq as DomainCreateUserMCPUpstreamReq,
  GithubComChaitinNemesisCodeBackendDomainMCPHeader as DomainMCPHeader,
  GithubComChaitinNemesisCodeBackendDomainMCPUpstream as DomainMCPUpstream,
} from "@/api/Api"
