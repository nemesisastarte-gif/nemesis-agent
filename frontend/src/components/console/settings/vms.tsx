...
import { type DomainVirtualMachine, GitInChaitinNetAiNemesiscodeNemesiscodeAiEntTypesConditionType, GithubComChaitinNemesisCodeBackendPkgTaskflowVirtualMachineStatus as TaskflowVirtualMachineStatus } from "@/api/Api";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
            ...
            <ItemContent className="min-w-0">
              ...
              <ItemDescription className="min-w-0 max-w-full overflow-hidden line-clamp-1 truncate">
                ...
                {vm.status === TaskflowVirtualMachineStatus.VirtualMachineStatusOffline && <>
                  {getLastCondition(vm)?.type === GitInChaitinNetAiNemesiscodeNemesiscodeAiEntTypesConditionType.ConditionTypeFailed ? (
                      getVmMessage(vm)
                    ) : (
