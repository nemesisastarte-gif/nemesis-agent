...
const NEMESISCODE_REPOSITORY_URL = "https://github.com/chaitin/nemesiscode"
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" asChild>
              <a href="/">
                <img src="/logo-light.png" alt="NemesisCode AI" className="size-8" />
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-medium">NemesisCode</span>
                  ...
                  <div className="flex min-w-0 items-center gap-1.5">
                    ...
                    {hasUpdate && (
                      <Badge asChild className="shrink-0">
                        <a href={NEMESISCODE_REPOSITORY_URL} target="_blank" rel="noreferrer">
