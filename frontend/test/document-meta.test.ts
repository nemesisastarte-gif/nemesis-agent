...
test("全局 meta 翻译资源提供中英文默认文案", () => {
  assert.deepEqual((cn as MetaResources).meta?.default, {
    ...
    description:
      "NemesisCode AI 是一个智能代码生成平台，通过AI驱动的编程助手、自动化工作流和智能开发工具，帮助开发者更快速地构建应用程序。",
    keywords: "AI代码生成, 智能编程, 开发者工具, 自动化编程, 代码助手, AI开发平台, NemesisCode, 人工智能编程",
  });

  assert.deepEqual((en as MetaResources).meta?.default, {
    title: "NemesisCode AI Platform",
    description:
      "NemesisCode AI is an intelligent code generation platform that helps developers build applications faster with AI-powered coding assistants, automated workflows, and smart development tools.",
    keywords: "AI code generation, intelligent programming, developer tools, automated programming, code assistant, AI development platform, NemesisCode, artificial intelligence programming",
  });
});
...
test("patchDocumentMeta 根据当前语言翻译更新全局 title 和 meta", async () => {
  ...
  const translations: Record<string, string> = {
    "meta.default.title": "NemesisCode Intelligent Development Platform",
    "meta.default.description": "Sign in to NemesisCode",
    "meta.default.keywords": "AI code generation, NemesisCode",
  };
