...
test("GitHub App 绑定地址按国内和国际版切换", () => {
  ...
  assert.match(commonSource, /https:\/\/github\.com\/apps\/nemesiscode-global\/installations\/new/);
  assert.match(commonSource, /https:\/\/github\.com\/apps\/nemesiscode-ai\/installations\/new/);
