...
//!
//! ```text
//! cargo bench -p xai-nemesis-pager --bench edit_highlight
//! cargo bench -p xai-nemesis-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use xai_nemesis_pager::diff::{DiffHunk, DiffLine};
use xai_nemesis_pager::scrollback::blocks::tool::{
...
use xai_nemesis_pager::syntax::{Syntect, get_syntect};
