//! Criterion benchmarks for the xai-nemesis-pager rendering pipeline.
//!
...
use xai_nemesis_pager::scrollback::render::render_scrolled_entries_with_scratch;
use xai_nemesis_pager::scrollback::wrappers::EntryRenderer;
use xai_nemesis_pager::scrollback::{
