...
//
// Concrete codes must match `xai_nemesis_voice::STT_LANGUAGES` (official Grok STT
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            keywords: &["model", "default", "agent", "llm", "nemesis", "switch"],
        ...
        // Catalog = official STT languages (see xai_nemesis_voice::STT_LANGUAGES).
        SettingMeta {
