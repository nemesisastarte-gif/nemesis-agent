...
//! ## Files
//!
//! `$NEMESIS_HOME/memtrace/<start-ts>-<pid>.jsonl` (+ `.1` after 4 MiB
...
//!
//! The lib cannot depend on jemalloc; `xai-nemesis-pager-bin` installs:
...
/// `dir` (e.g. `$NEMESIS_HOME/memtrace/`) and spawn the detached sampler
