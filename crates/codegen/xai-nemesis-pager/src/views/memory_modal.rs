...
pub fn build_entries(
    files: Vec<xai_nemesis_shell::extensions::notification::MemoryFileInfo>,
) -> Vec<MemoryFileEntry> {
...
mod tests {
    ...
    fn file_label_extracts_filename() {
        assert_eq!(file_label("/home/user/.nemesis/memory/MEMORY.md"), "MEMORY.md");
        assert_eq!(
            file_label("/workspace/.nemesis/memory/sessions/2026-01-15-fix-bug.md"),
    ...
    fn build_entries_groups_by_source() {
        use xai_nemesis_shell::extensions::notification::MemoryFileInfo;
