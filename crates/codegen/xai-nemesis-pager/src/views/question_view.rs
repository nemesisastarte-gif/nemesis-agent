...
use xai_nemesis_markdown::StreamingMarkdownRenderer;
pub use xai_nemesis_tools::implementations::grok_build::ask_user_question::{
...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<xai_nemesis_telemetry::events::CreditLimitChoice>,
    },
    ...
    FreeUsageUpsell {
        ...
        source: xai_nemesis_telemetry::events::SuperGrokUpsell,
    },
    ...
    AgentTypeMismatch {
        ...
        effort: Option<xai_nemesis_shell::sampling::types::ReasoningEffort>,
    },
}
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> xai_nemesis_tools::implementations::grok_build::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: xai_nemesis_tools::implementations::grok_build::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
