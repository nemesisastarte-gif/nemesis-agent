...
pub struct NotificationMeta {
    ...
    /// (`"{sessionId}-{counter}"`, see `xai-nemesis-shell util::event_id`). The
...
/// replayed notifications (`_meta.isReplay`, stamped by xai-nemesis-shell's
...
pub mod user_message_chunk_meta {
    ...
    /// ([`xai_nemesis_shell::session::PromptOrigin::hide_user_echo_from_scrollback`]).
