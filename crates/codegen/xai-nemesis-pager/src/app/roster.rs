...
/// `xai-nemesis-shell/src/agent/handlers/session.rs::handle_roster_list`), which
...
mod tests {
    ...
    fn agent_entry() -> xai_nemesis_shell::agent::roster::RosterEntry {
        use xai_nemesis_shell::agent::roster as agent;
        agent::RosterEntry {
