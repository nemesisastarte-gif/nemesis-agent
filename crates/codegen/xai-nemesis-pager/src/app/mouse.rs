            ...
            MouseEventKind::Down(MouseButton::Left) => {
                    ...
                    && !self.pos_occluded(mouse.column, mouse.row)
                {
                    return InputOutcome::Action(Action::AnnouncementsOpenCta(
                        xai_nemesis_telemetry::events::AnnouncementCtaSurface::Banner,
                    ));
                }
                if self
                    .plugin_cta
                        ...
                        &self.plugin_cta.phase
                {
                    ...
                    if let Err(e) = xai_nemesis_shell::config::add_dismissed_plugin_cta(&plugin_id) {
                        tracing::warn!(
                    ...
                    xai_nemesis_telemetry::session_ctx::log_event(
                        xai_nemesis_telemetry::events::PluginCtaDismissed {
                ...
                {
                    return InputOutcome::Action(Action::AnnouncementsOpenCta(
                        xai_nemesis_telemetry::events::AnnouncementCtaSurface::Header,
                    ));
                }
                        ...
                        if let Some(idx) = hit_idx {
                                    ...
                                    .entry_screen_area(idx, self.pane_areas.scrollback)
                            {
                                ...
                                if click_row >= url_row {
                                    ...
                                    xai_nemesis_telemetry::session_ctx::log_event(xai_nemesis_telemetry::events::CreditLimitUpsellClicked {
