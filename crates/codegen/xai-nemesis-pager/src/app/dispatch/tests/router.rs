...
fn critical_announcement(id: &str) -> xai_nemesis_announcements::RemoteAnnouncement {
...
fn promo_announcement(id: &str) -> xai_nemesis_announcements::RemoteAnnouncement {
    xai_nemesis_announcements::RemoteAnnouncement {
        id: Some(id.into()),
        message: Some(format!("{id} message")),
        severity: Some("promo".into()),
        cta: Some(xai_nemesis_announcements::AnnouncementCta {
            label: Some("Go".into()),
...
fn tick_propagates_available_commands_to_bootstrap() {
    ...
    let skill_meta = serde_json::json!(
        { "scope" : "user", "path" : "/home/user/.nemesis/skills/pick-best/SKILL.md", }
    );
