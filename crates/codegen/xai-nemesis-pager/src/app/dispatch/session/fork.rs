...
-> [xai_nemesis_tools::implementations::grok_build::ask_user_question::QuestionOption; 2] {
    use xai_nemesis_tools::implementations::grok_build::ask_user_question::QuestionOption;
    [
        QuestionOption {
