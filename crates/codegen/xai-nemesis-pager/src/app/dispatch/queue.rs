...
///
/// Delegates to the shared implementation in `xai_nemesis_tools::reminders`.
...
fn format_cron_prompt(prompt: &str, task_id: &str, human_schedule: &str) -> String {
    xai_nemesis_tools::reminders::format_scheduled_task_prompt(prompt, task_id, human_schedule)
}
...
if text == "queued"));
    ...
    fn drain_scroll_honors_page_flip_setting() {
        ...
        crate::appearance::cache::set_page_flip_on_send(
            xai_nemesis_shell::agent::config::UiConfig::PAGE_FLIP_ON_SEND_DEFAULT,
        );
    }
