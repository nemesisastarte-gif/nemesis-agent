...
pub(super) fn push_server_status_enabled() -> bool {
    ...
    *ENABLED.get_or_init(|| {
        xai_nemesis_shell::util::config::resolve_mcp_push_server_status(
...
/// `xai-nemesis-shell/src/session/acp_session.rs` — toggle-tool ~L6661,
...
///    [`xai_nemesis_shell::extensions::mcp::McpToolsChanged`] struct), and
...
/// ([`xai_nemesis_shell::extensions::mcp::McpServerStatusPayload`] +
/// [`xai_nemesis_shell::extensions::mcp::McpServerStatus`]) instead of
...
pub(super) fn handle_mcp_server_status(notif: &acp::ExtNotification, app: &mut AppView) -> bool {
    ...
    use xai_nemesis_shell::extensions::mcp::{McpServerStatus, McpServerStatusPayload, McpToolEntry};
...
/// on config reload (`crates/codegen/xai-nemesis-shell/src/agent/mvp_agent.rs`
