...
//!
//! ```text
//! cargo run -p xai-nemesis-pager --bin todo-pane-playground
//! ```
//!
...
use xai_nemesis_pager::views::todo_pane::TodoPane;
use xai_nemesis_shell::tools::{TodoItem, TodoPriority, TodoStatus};
