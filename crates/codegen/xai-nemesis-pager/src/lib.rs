//! xai-nemesis-pager — Nemesis Agent TUI.
//!
...
// minimal rendering lives in the sibling `xai-nemesis-pager-minimal` crate; these
...
// `xai-nemesis-pager-render`. Re-exported at the crate root so existing
// `crate::<module>::...` references throughout the pager keep resolving.
pub use xai_nemesis_pager_render::{
