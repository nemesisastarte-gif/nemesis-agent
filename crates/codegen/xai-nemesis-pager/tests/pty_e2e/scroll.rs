...
use xai_nemesis_pager_pty_harness::PtyHarness;
pub(crate) use xai_nemesis_pager_pty_harness::{SGR_SCROLL_DOWN, SGR_SCROLL_UP};
...
/// (`xai-nemesis-pager-pty-harness/src/scroll_matrix/runner.rs`) ports this
...
/// `xai-nemesis-pager-pty-harness/src/scroll_matrix/session.rs` is a port of
