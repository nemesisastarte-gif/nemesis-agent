//! Unified PTY harness for xai-nemesis-pager.
//!
...
//!    `xai-nemesis-pager/tests/scenarios/`) — assert screen contents and
...
impl PtyHarness {
    ...
    /// # use xai_nemesis_pager_pty_harness::{PtyHarness, ContentController, pager_binary};
