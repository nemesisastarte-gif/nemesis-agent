...
//!
//! Run with: cargo test -p xai-nemesis-mcp --test repro_sse_flood -- --nocapture
...
use xai_nemesis_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use xai_nemesis_mcp::rmcp::ServiceExt;
use xai_nemesis_mcp::rmcp::transport::StreamableHttpClientTransport;
use xai_nemesis_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
