...
impl HubHandle {
    ...
    pub(crate) async fn connect(
        ...
        let mut server_builder = ToolServerBuilder::default()
            ...
            .binary_version(xai_nemesis_version::VERSION)
...
mod tests {
    ...
    use xai_nemesis_tools::types::tool_metadata::ToolMetadata as XaiToolMetadata;
    #[derive(Debug)]
    ...
    fn bg_started_notif(task_id: &str) -> ToolNotification {
        use xai_nemesis_tools::notification::types::{
    ...
    fn task_completed_notif(task_id: &str) -> ToolNotification {
        use xai_nemesis_tools::computer::types::{TaskKind, TaskSnapshot};
