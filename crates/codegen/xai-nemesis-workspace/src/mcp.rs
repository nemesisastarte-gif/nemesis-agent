...
use xai_nemesis_mcp::servers::{McpClient, parse_mcp_qualified_name};
...
/// Extract a server name from an [`McpError`](xai_nemesis_mcp::servers::McpError),
/// falling back to `"unknown"`.
pub(crate) fn server_name_from_mcp_error(e: &xai_nemesis_mcp::servers::McpError) -> &str {
