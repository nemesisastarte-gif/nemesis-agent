...
pub enum ClientType {
    ...
    ///
    /// Accepts both the hyphenated `"nemesis-agent"` (what the pager actually
    ...
    #[serde(rename = "nemesis-agent", alias = "grok_pager")]
    GrokPager,
...
impl ClientType {
    ...
    pub fn from_client_identifier(id: Option<&str>) -> Self {
        match id {
            ...
            Some("nemesis-agent") => Self::GrokPager,
            _ => Self::Generic,
        }
    }
...
impl From<&xai_nemesis_tools::types::ToolInput> for AccessKind {
    fn from(input: &xai_nemesis_tools::types::ToolInput) -> Self {
...
pub enum RequirementSource {
    Unknown,
    /// User-writable `~/.nemesis/requirements.toml` — untrusted for keeping a
...
mod tests {
    ...
    fn hashline_edit_maps_to_edit_access() {
        use xai_nemesis_tools::implementations::grok_build_hashline::edit::types::HashlineEditInput;
        use xai_nemesis_tools::types::ToolInput;
    ...
    fn bash_maps_to_bash_access() {
        use xai_nemesis_tools::implementations::grok_build::bash::BashToolInput;
        use xai_nemesis_tools::types::ToolInput;
    ...
    fn use_tool_maps_to_mcp_tool_access() {
        use xai_nemesis_tools::implementations::use_tool::UseToolInput;
        use xai_nemesis_tools::types::ToolInput;
...
if name ==
    ...
    fn monitor_maps_to_bash_access() {
        use xai_nemesis_tools::implementations::grok_build::monitor::types::MonitorInput;
        use xai_nemesis_tools::types::ToolInput;
    ...
    fn web_fetch_maps_to_web_fetch_access() {
        use xai_nemesis_tools::implementations::grok_build::web_fetch::WebFetchInput;
        use xai_nemesis_tools::types::ToolInput;
    ...
    fn web_search_maps_to_web_search_access() {
        use xai_nemesis_tools::implementations::grok_build::web_search::WebSearchInput;
        use xai_nemesis_tools::types::ToolInput;
