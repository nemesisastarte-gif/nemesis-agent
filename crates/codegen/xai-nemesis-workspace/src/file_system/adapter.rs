//! AcpFsAdapter: implements `xai-nemesis-tools::AsyncFileSystem` using ACP gateway calls.
//!
//! This adapter enables file tool execution over ACP (remote filesystem).
//! It translates xai-nemesis-tools' `AsyncFileSystem` trait into ACP protocol calls:
...
use xai_nemesis_tools::computer::types::{AsyncFileSystem, ComputerError};

/// Wraps xai-nemesis-shell's ACP gateway to satisfy xai-nemesis-tools' AsyncFileSystem.
///
