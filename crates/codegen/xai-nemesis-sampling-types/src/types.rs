...
// Re-export ToolDefinition and FunctionTool from xai-nemesis-tools.
...
pub use xai_nemesis_tools::types::definition::{FunctionTool, ToolDefinition};
...
mod tests {
    ...
    fn parse_reasoning_efforts_meta_absent_is_none() {
        ...
        assert!(
            parse_reasoning_efforts_meta(Some(json!({ "agentType": "nemesis" }).as_object().unwrap()))
                .is_none()
        );
    }
