...
// engine in `crates/common/xai-nemesis-compaction` operate over grok-build's
...
impl xai_nemesis_compaction::CompactionItem for ConversationItem {
    fn role(&self) -> xai_nemesis_compaction::CompactionRole {
        use xai_nemesis_compaction::CompactionRole;
    ...
    fn attachment_refs(&self) -> Vec<xai_nemesis_compaction::CompactionFileRef> {
...
impl xai_nemesis_compaction::CompactionItemFactory for ConversationItem {
...
/// ([stream/messages.rs:340](crates/codegen/xai-nemesis-sampler/src/stream/messages.rs))
...
///
/// This is `pub` so downstream crates (`xai-nemesis-shell`) can re-use it
...
impl From<ChatResponseMessage> for ConversationItem {
    fn from(msg: ChatResponseMessage) -> Self {
        ...
        // ([crates/codegen/xai-nemesis-sampler/src/stream/chat_completions.rs])
...
/// ([crates/codegen/xai-nemesis-sampler/src/stream/messages.rs]) instead
...
mod compaction_item_bridge_tests {
    use super::*;
    use xai_nemesis_compaction::{CompactionItem, CompactionItemFactory, CompactionRole};
...
if text == "Compare these images:");
    ...
    fn test_transform_cwd_transforms_tool_call_arguments() {
        ...
        let worktree = "/home/user/.nemesis/worktrees/project/ab-uuid-a";
    ...
    fn test_transform_cwd_worktree_to_root_syncback() {
        ...
        let worktree = "/home/user/.nemesis/worktrees/myproject/fork-a";
    ...
    fn test_transform_cwd_assistant_only_tool_calls_no_content() {
        ...
        let worktree = "/home/user/.nemesis/worktrees/proj/fork-a";
