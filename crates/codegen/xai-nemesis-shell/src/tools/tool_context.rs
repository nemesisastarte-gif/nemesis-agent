...
//! xai-nemesis-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use xai_nemesis_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use xai_nemesis_workspace::session::file_state::FileStateHandle;
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn xai_nemesis_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<xai_nemesis_tools::implementations::grok_build::task::types::MonitorEventBuffer>,
    ...
    pub task_wake_suppressed:
        Option<xai_nemesis_tools::reminders::task_completion::TaskWakeSuppressed>,
...
impl ToolContext {
    pub fn new(
        ...
        let session_env = xai_nemesis_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
