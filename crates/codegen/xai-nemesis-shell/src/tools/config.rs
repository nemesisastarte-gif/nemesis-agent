...
use xai_nemesis_sampler::SamplerConfig;
...
impl WebFetchToolConfig {
    ...
    pub fn resolve_params(
    ...
    ) -> xai_nemesis_tools::implementations::grok_build::web_fetch::WebFetchParams {
        ...
        let allow_local = self
            .allow_local
            .or_else(|| xai_nemesis_config::env_bool("GROK_WEB_FETCH_ALLOW_LOCAL"));
...
/// from `xai_nemesis_tools::registry::types::ToolsetConfig` which holds
...
mod tests {
    ...
    fn file_toolset_override_never_grants_edit_to_read_only_toolsets() {
        ...
        for mut def in [
            xai_nemesis_agent::config::AgentDefinition::plan(),
            xai_nemesis_agent::config::AgentDefinition::explore(),
        ] {
