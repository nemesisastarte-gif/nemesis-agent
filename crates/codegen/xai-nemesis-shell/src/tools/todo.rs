//! Todo types — re-exported from `xai-nemesis-tools` with ACP conversion helpers.
//!
//! Types are canonical in `xai-nemesis-tools`. This module adds ACP ↔ TodoItem
//! conversions since `xai-nemesis-tools` is protocol-agnostic.

pub use xai_nemesis_tools::implementations::grok_build::todo::TodoId;
pub use xai_nemesis_tools::implementations::grok_build::todo::TodoItem;
pub use xai_nemesis_tools::implementations::grok_build::todo::TodoPriority;
pub use xai_nemesis_tools::implementations::grok_build::todo::TodoState;
pub use xai_nemesis_tools::implementations::grok_build::todo::TodoStatus;
