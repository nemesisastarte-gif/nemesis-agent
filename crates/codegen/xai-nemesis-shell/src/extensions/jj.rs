//! Jujutsu extension handlers — delegates to [`xai_nemesis_workspace::session::jj`].

use agent_client_protocol as acp;

use super::{Empty, ExtResult, to_ext_response, to_ext_response_partial};
use xai_nemesis_workspace::session::git::{CommitData, StageData};
use xai_nemesis_workspace::session::jj;
