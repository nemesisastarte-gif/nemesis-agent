...
pub fn loaded_plugin_to_info(plugin: &xai_nemesis_agent::plugins::LoadedPlugin) -> PluginInfo {
    use xai_nemesis_agent::plugins::discovery::PluginScope as AgentScope;
...
fn origin_to_dto(origin: &xai_nemesis_agent::plugins::PluginOrigin) -> PluginOrigin {
    use xai_nemesis_agent::plugins::PluginOrigin as AgentOrigin;
    match origin {
...
mod tests {
    use super::*;
    use xai_nemesis_agent::plugins::PluginOrigin as AgentOrigin;
    use xai_nemesis_agent::plugins::discovery::{PluginId, PluginScope as AgentScope};

    fn make_loaded_plugin(origin: AgentOrigin) -> xai_nemesis_agent::plugins::LoadedPlugin {
        let root = std::path::PathBuf::from("/tmp/test-plugin");
        xai_nemesis_agent::plugins::LoadedPlugin {
