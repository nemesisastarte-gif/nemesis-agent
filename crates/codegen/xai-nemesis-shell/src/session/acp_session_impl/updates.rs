...
impl SessionActor {
        ...
        match &notification.update {
            XaiSessionUpdate::SubagentSpawned {
                ...
                let envelope = self.fire_hook(
                    xai_nemesis_hooks::event::HookEventName::SubagentStart,
                    None,
                    xai_nemesis_hooks::event::HookPayload::SubagentStart {
                ...
                if let Some(registry) = hook_registry_snapshot {
                    ...
                    let _ = xai_nemesis_hooks::dispatcher::dispatch_non_blocking(
                        &registry,
                        xai_nemesis_hooks::event::HookEventName::SubagentStart,
                        &envelope,
                        &ctx,
    ...
    pub(super) async fn dispatch_notification_hook(
        ...
        let envelope = self.fire_hook(
            xai_nemesis_hooks::event::HookEventName::Notification,
            None,
            xai_nemesis_hooks::event::HookPayload::Notification {
