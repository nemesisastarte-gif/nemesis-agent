...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<xai_nemesis_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(xai_nemesis_tools::implementations::grok_build::update_goal::UpdateGoalInput),
    Channel(xai_nemesis_tools::implementations::grok_build::update_goal::UpdateGoalEnvelope),
}
