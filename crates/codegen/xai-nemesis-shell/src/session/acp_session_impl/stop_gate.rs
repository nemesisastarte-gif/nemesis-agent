...
/// `description` instead.
fn stop_entry_from_task(task: &xai_nemesis_tools::types::TaskSnapshot) -> StopBackgroundTask {
    let command_text =
...
fn stop_entry_from_subagent(
    summary: &xai_nemesis_tools::implementations::grok_build::task::types::ActiveSubagentSummary,
) -> StopBackgroundTask {
    StopBackgroundTask {
...
fn stop_cron_from_scheduled(
    task: &xai_nemesis_tools::implementations::grok_build::scheduler::types::ScheduledTask,
) -> StopSessionCron {
    StopSessionCron {
        id: task.id.clone(),
        schedule:
            xai_nemesis_tools::implementations::grok_build::scheduler::interval::interval_to_human(
                task.interval_secs,
            ),
...
pub(super) fn demote_ignored_blocks(
    ...
    use xai_nemesis_hooks::result::HookRunResult;
    results
        .into_iter()
...
impl SessionActor {
    ...
    pub(crate) async fn list_active_subagents(
        &self,
    ) -> Vec<xai_nemesis_tools::implementations::grok_build::task::types::ActiveSubagentSummary> {
    ...
    async fn announce_keep_working(
        ...
        for block in blocks {
            ...
            .await;
            xai_nemesis_telemetry::session_ctx::log_event(xai_nemesis_telemetry::events::HookBlocked {
...
mod stop_gate_snapshot_tests {
    ...
    fn task_snapshot(
        kind: xai_nemesis_tools::computer::types::TaskKind,
    ...
    fn subagent_summary_maps_to_stop_entry() {
        let summary =
            xai_nemesis_tools::implementations::grok_build::task::types::ActiveSubagentSummary {
    ...
    fn scheduled_task_maps_to_stop_cron() {
        let task =
            xai_nemesis_tools::implementations::grok_build::scheduler::types::ScheduledTask::new(
                300,
