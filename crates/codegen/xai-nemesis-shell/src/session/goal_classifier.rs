...
pub(crate) fn build_subagent_trace_items(
    ...
    prompt: &str,
    output: &str,
) -> Vec<xai_nemesis_sampling_types::conversation::ConversationItem> {
    use xai_nemesis_sampling_types::conversation::{ConversationItem, ToolCall};
...
mod tests {
    ...
    fn verifier_template_renders_per_agent_type_and_falls_back() {
        ...
        tool_names.insert(
            xai_nemesis_tools::types::tool::ToolKind::ListDir,
            "cursor_ls".to_string(),
        );
        tool_names.insert(
            xai_nemesis_tools::types::tool::ToolKind::Search,
        ...
        let grok = RoleToolNames::from_summary(&summary_with(&[
            (xai_nemesis_tools::types::tool::ToolKind::Read, "read_file"),
            (xai_nemesis_tools::types::tool::ToolKind::ListDir, "list_dir"),
            (xai_nemesis_tools::types::tool::ToolKind::Search, "grep"),
        ]))
    ...
    fn cold_and_resume_renders_are_symmetric_for_an_index() {
        let summary = summary_with(&[
            (xai_nemesis_tools::types::tool::ToolKind::Read, "cursor_read"),
            (xai_nemesis_tools::types::tool::ToolKind::ListDir, "cursor_ls"),
            (xai_nemesis_tools::types::tool::ToolKind::Search, "cursor_grep"),
        ]);
