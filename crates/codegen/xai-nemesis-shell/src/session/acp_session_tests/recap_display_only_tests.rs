...
fn over_budget_recap_serializes_to_well_formed_messages_request() {
    ...
    use xai_nemesis_sampling_types::messages::{ContentBlock, MessageContent, MessageRole};
    use xai_nemesis_sampling_types::{ConversationRequest, ToolCall, rs};
    ...
    let msg = xai_nemesis_sampling_types::build_messages_request(&req);
