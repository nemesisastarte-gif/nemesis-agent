...
use xai_nemesis_sampling_types::{ConversationItem, SyntheticReason};
#[test]
...
async fn rebuild_reinjects_task_completion_resource_identity() {
    use xai_nemesis_tools::reminders::task_completion::{
...
fn regression_skill() -> xai_nemesis_tools::implementations::skills::types::SkillInfo {
