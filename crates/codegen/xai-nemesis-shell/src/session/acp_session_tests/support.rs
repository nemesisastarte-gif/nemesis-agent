...
#[cfg(test)]
pub(crate) async fn test_agent_default() -> xai_nemesis_agent::Agent {
...
#[cfg(test)]
pub(crate) async fn test_agent_with_goal_tool() -> xai_nemesis_agent::Agent {
    use xai_nemesis_tools::implementations::grok_build::update_goal::UpdateGoalTool;
...
#[cfg(test)]
pub(crate) async fn test_grok_build_agent_with_todo() -> xai_nemesis_agent::Agent {
    use xai_nemesis_tools::implementations::grok_build::todo::TodoWriteTool;
    use xai_nemesis_tools::registry::types::ToolConfig;
...
#[cfg(test)]
pub(crate) async fn test_agent_with_plan_tools() -> xai_nemesis_agent::Agent {
    use xai_nemesis_tools::implementations::grok_build::enter_plan_mode::EnterPlanModeTool;
    use xai_nemesis_tools::implementations::grok_build::exit_plan_mode::ExitPlanModeTool;
    use xai_nemesis_tools::registry::types::ToolConfig;
...
pub(crate) async fn test_agent_with_tools(
    tools: Vec<xai_nemesis_tools::registry::types::ToolConfig>,
) -> xai_nemesis_agent::Agent {
    test_agent_from_config(
        xai_nemesis_tools::registry::types::ToolServerConfig {
            tools,
            behavior_preset: None,
        },
        xai_nemesis_agent::AgentDefinition::default_grok_build(),
        std::sync::Arc::new(xai_nemesis_tools::computer::local::LocalTerminalBackend::new()),
    )
    .await
}
#[cfg(test)]
async fn test_agent_from_config(
    ...
    definition: xai_nemesis_agent::AgentDefinition,
    backend: std::sync::Arc<dyn xai_nemesis_tools::computer::types::TerminalBackend>,
) -> xai_nemesis_agent::Agent {
    use xai_nemesis_tools::computer::local::LocalFs;
    use xai_nemesis_tools::computer::types::AsyncFileSystem;
    ...
    xai_nemesis_agent::Agent::new(
        definition,
        xai_nemesis_agent::PromptContext::default(),
        String::new(),
        tool_bridge,
        xai_nemesis_agent::ReminderPolicy::default(),
        xai_nemesis_agent::CompactionPolicy::default(),
        vec![],
        false,
    )
}
...
pub(crate) async fn create_test_actor_ex(
    ...
    let cwd = xai_nemesis_paths::AbsPathBuf::new(std::path::PathBuf::from("/tmp")).unwrap();
    let fs = Arc::new(xai_nemesis_workspace::file_system::MockFs::new(
        cwd.to_path_buf(),
    ));
    ...
    tool_context.task_completion_reservations =
        Some(xai_nemesis_tools::reminders::task_completion::TaskCompletionReservations::default());
    tool_context.task_wake_suppressed =
        Some(xai_nemesis_tools::reminders::task_completion::TaskWakeSuppressed::default());
    ...
    let actor = SessionActor {
        ...
        permissions: xai_nemesis_workspace::permission::PermissionHandle::allow_all(),
        tool_context,
