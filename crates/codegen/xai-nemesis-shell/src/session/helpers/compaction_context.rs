...
//! shell-specific types (`xai_nemesis_tools::MemoryBackend`, memory context).
//!
...
//! [`xai_nemesis_compaction::reminder`] so grok-chat and grok-build stay in lockstep.
...
use xai_nemesis_compaction::reminder::{
...
pub fn to_system_reminder_sync(
    ...
    skills: &[xai_nemesis_tools::implementations::skills::types::SkillInfo],
...
pub async fn to_system_reminder(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[xai_nemesis_tools::implementations::skills::types::SkillInfo],
    memory_backend: Option<&dyn xai_nemesis_tools::types::memory_backend::MemoryBackend>,
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
) -> Option<String> {
...
fn to_system_reminder_inner(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[xai_nemesis_tools::implementations::skills::types::SkillInfo],
    memory_results: &[xai_nemesis_tools::types::memory_backend::MemorySearchResult],
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
) -> Option<String> {
    ...
    if let Some(listing) =
        xai_nemesis_tools::types::skill_discovery_tracker::format_compaction_skill_listing(skills)
    {
    ...
    if !ctx.connected_mcp_servers.is_empty() {
        use xai_nemesis_tools::implementations::search_tool::format_compaction_server_line;
