...
pub enum SessionCommand {
    ...
    ReloadPlugins {
        registry: Option<std::sync::Arc<xai_nemesis_agent::plugins::PluginRegistry>>,
    },
    /// Re-discover the session's own project hooks (`.nemesis/hooks`,
    ...
    SnapshotToolDefinitions {
        respond_to: oneshot::Sender<Vec<xai_nemesis_sampling_types::ToolSpec>>,
    },
    ...
    KillBackgroundTask {
        task_id: String,
        respond_to: oneshot::Sender<Result<xai_nemesis_tools::types::KillOutcome, String>>,
    },
    DeleteScheduledTask {
        task_id: String,
    ...
    ListTasks {
        respond_to: oneshot::Sender<Option<Vec<xai_nemesis_tools::types::TaskSnapshot>>>,
    },
    ...
    PluginsList {
        respond_to:
            oneshot::Sender<Option<std::sync::Arc<xai_nemesis_agent::plugins::PluginRegistry>>>,
    },
    ...
    TakeHarnessTraceTurns {
        respond_to:
            oneshot::Sender<Vec<Vec<xai_nemesis_sampling_types::conversation::ConversationItem>>>,
    },
