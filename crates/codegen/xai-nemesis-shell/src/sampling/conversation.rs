...
//!
//! The canonical types now live in `xai_nemesis_sampling_types::conversation`.
...
pub use xai_nemesis_sampling_types::conversation::*;
...
///
/// Stays in `xai-nemesis-shell` because it references
...
// via `Box::new(trace)`.
//
// Tests for conversation types now live in xai-nemesis-sampling-types crate.
