//! AcpTerminalAdapter: implements `xai-nemesis-tools::TerminalBackend` using ACP gateway calls.
//!
//! This adapter enables bash tool execution over ACP (remote execution).
//! It translates xai-nemesis-tools' `TerminalBackend` trait into ACP protocol calls:
...
use xai_nemesis_tools::computer::types::{
...
/// Wraps xai-nemesis-shell's ACP gateway to satisfy xai-nemesis-tools' TerminalBackend.
