...
pub(crate) const ENV_COMPACTION_TOOL_CHOICE: &str = "NEMESIS_COMPACTION_TOOL_CHOICE";
...
const ENV_COMPACTION_WALL_CLOCK_BUDGET_SECS: &str = "NEMESIS_COMPACTION_WALL_CLOCK_SECS";

/// Resolve the per-compaction wall-clock budget (seconds). Precedence: env
/// `NEMESIS_COMPACTION_WALL_CLOCK_SECS` > remote settings global
...
mod compaction_wall_clock_budget_tests {
    ...
    // Assumes NEMESIS_COMPACTION_WALL_CLOCK_SECS is unset in the test env.
    #[test]
