...
use clap::Parser;
use xai_nemesis_shell::sampling::conversation::{ConversationItem, conversation_item_to_chat_message};
use xai_nemesis_shell::sampling::types::{ChatRequestMessage, Role};
