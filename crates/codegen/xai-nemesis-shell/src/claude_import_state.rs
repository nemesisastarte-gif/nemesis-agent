...
//
// State is persisted to `~/.nemesis/claude_import_state.json`.
...
use xai_nemesis_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.nemesis/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::nemesis_home::nemesis_home().join("claude_import_state.json")
}
