...
use xai_nemesis_tools::implementations::grok_build::task::types::{SubagentRequest, SubagentResult};
...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        sampling_config: xai_nemesis_sampler::SamplerConfig {
            api_key: None,
            base_url: String::new(),
            model: String::new(),
        ...
        fs: Arc::new(xai_nemesis_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        parent_skills: None,
        parent_skills_config: xai_nemesis_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: xai_nemesis_tools::types::compat::CompatConfig::default(),
        task_completion_reservations: None,
        synthetic_trace_tx: None,
        task_output_tool_name: xai_nemesis_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl xai_nemesis_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &xai_nemesis_tools::implementations::lsp::LspToolInput,
    ) -> xai_nemesis_tools::implementations::lsp::LspToolResult {
        xai_nemesis_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<xai_nemesis_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<xai_nemesis_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
