...
use xai_nemesis_shell::auth::{AuthManager, AuthMode, GrokAuth, GrokComConfig};
use xai_nemesis_shell::heap_profile::{
...
use xai_nemesis_test_support::{EnvGuard, MockInferenceServer};
use xai_nemesis_version::TEST_VERSION_ENV;
...
fn assert_storage_auth(uploads: &[xai_nemesis_test_support::mock_server::StorageUpload]) {
    for u in uploads {
        assert_eq!(
