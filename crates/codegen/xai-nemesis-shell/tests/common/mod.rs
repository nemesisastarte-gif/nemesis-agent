//! Shared helpers for xai-nemesis-shell integration tests.

use xai_nemesis_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `xai_nemesis_sampler::SamplingClient`, which takes a
