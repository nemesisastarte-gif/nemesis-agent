...
//!
//! Extracted from `xai-nemesis-shell/src/agent/subagent/` `resolve_effective_overrides()`.

use std::collections::HashMap;
use std::path::Path;

use serde::de::DeserializeOwned;
use xai_nemesis_tools::implementations::grok_build::task::types::SubagentRuntimeOverrides;
...
mod tests {
    use super::*;
    use xai_nemesis_tools::implementations::grok_build::task::types::ModelOverrideProvenance;
