...
//! `xai_nemesis_shell::config::{SubagentRole, SubagentPersona, PersonaIOField}`.
//!
//! Methods that remain in `xai-nemesis-shell` (on `SubagentsConfig`):
...
prompt_file = ".nemesis/prompts/researcher.md"
...
"#;
        ...
        assert_eq!(
            ...
            Some(".nemesis/prompts/researcher.md")
        );
...
"#;
        ...
        assert_eq!(
            ...
            Some(".nemesis/personas/concise.md")
        );
