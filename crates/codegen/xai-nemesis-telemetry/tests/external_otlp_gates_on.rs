...
use xai_nemesis_telemetry::external::{self, ExternalOtelRemotePolicy, IdentityAttrs};
...
fn external_stream_gates_on_end_to_end() {
    ...
    xai_nemesis_telemetry::log_event(xai_nemesis_telemetry::events::ToolCallCompleted {
