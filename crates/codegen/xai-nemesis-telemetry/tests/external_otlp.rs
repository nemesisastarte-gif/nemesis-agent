...
fn external_stream_end_to_end() {
    ...
    let mut cfg = xai_nemesis_telemetry::external::ExternalOtelConfig::resolve_with(
        |name| match name {
    ...
    cfg.client = xai_nemesis_telemetry::external::config::ExternalClientInfo {
        service_version: "0.0.0-test".into(),
        client_version: "0.0.0-test".into(),
        app_entrypoint: "cli".into(),
    };

    xai_nemesis_telemetry::external::init(Some(cfg));
    assert!(xai_nemesis_telemetry::external::is_active());
    ...
    assert!(!xai_nemesis_telemetry::is_enabled());
    xai_nemesis_telemetry::log_event(xai_nemesis_telemetry::events::SessionNew {
        session_id: "sess-int-1".into(),
        client_identifier: None,
        client_version: None,
        is_git_repo: true,
        permission_mode: xai_nemesis_telemetry::enums::PermissionMode::Ask,
    });
    xai_nemesis_telemetry::log_event(xai_nemesis_telemetry::events::SessionHarness {
        session_id: "sess-int-1".into(),
        client_identifier: Some("nemesis-agent".into()),
    ...
    xai_nemesis_telemetry::log_event(xai_nemesis_telemetry::events::PromptSubmitted {
    ...
    xai_nemesis_telemetry::log_event(xai_nemesis_telemetry::events::ModelResponseReceived {
    ...
    xai_nemesis_telemetry::external::shutdown();
    assert!(
