...
//!
//! These structs were extracted from `xai-nemesis-shell` so they can be
...
// ---------------------------------------------------------------------------
// Pager events (called from xai-nemesis-pager via log_event)
// ---------------------------------------------------------------------------
...
/// first prompt when Nemesis Agent is launched from a non-project directory).
...
/// attributed to Nemesis Agent: the user saw the gate in Nemesis Agent, went and
...
pub struct SubscriptionActivated {
    ...
    /// is strongly attributable to Nemesis Agent's upsell surface.
