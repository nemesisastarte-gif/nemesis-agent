...
//! 2. `$NEMESIS_HOME/managed_config.toml`
//! 3. `$NEMESIS_HOME/config.toml`
//! 4. `$NEMESIS_HOME/requirements.toml` (cloud cache; Ed25519-signed at rest once a
...
pub use paths::{
    ...
    default_nemesis_home, encode_cwd_dirname, ensure_sessions_cwd_dir, grok_application,
    grok_application_in, nemesis_home, sessions_cwd_dir, system_config_dir, user_nemesis_home,
};
pub use validation::{
