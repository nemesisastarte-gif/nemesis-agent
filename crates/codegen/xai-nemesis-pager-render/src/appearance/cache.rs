...
//!
//! Disk writes live in `xai_nemesis_shell::util::config::set_<field>()`.
...
use xai_nemesis_shared::ui_config::UiConfig;
...
fn load_bool_from_effective_config(key: &str, default: bool) -> bool {
    let root = match xai_nemesis_config::load_effective_config_disk_only() {
        Ok(r) => r,
