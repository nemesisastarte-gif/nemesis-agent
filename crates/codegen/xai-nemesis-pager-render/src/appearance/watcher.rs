...
//!
//! In dev mode, watches ~/.nemesis/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.nemesis/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.nemesis/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = xai_nemesis_config::user_nemesis_home()
