...
///
/// Delegates to [`xai_nemesis_tools::util::substitute_plugin_tokens`], the single
...
pub fn substitute_env_vars(s: &str, plugin_root: &str, plugin_data: &str) -> String {
    xai_nemesis_tools::util::substitute_plugin_tokens(s, Some(plugin_root), Some(plugin_data))
}
