...
//! `TemplateRenderer` in `xai-nemesis-tools`. This struct does NOT own a
...
pub const DEFAULT_SYSTEM_PROMPT_LABEL: &str = "Nemesis";
...
mod tests {
    ...
    fn test_agents_md_paths_use_display_cwd_in_rendered_section() {
        ...
        let overlay_path = "/root/.nemesis/worktrees/my-project/ab-123-a-overlay";
    ...
    fn trimmed_prompts_no_redundant_identity() {
        ...
        for (name, prompt) in [
            ...
            assert!(
                !prompt.contains("You are a Nemesis Agent agent"),
