...
use std::sync::Arc;
use xai_nemesis_tools::bridge::ToolBridge;
use xai_nemesis_tools::computer::types::{AsyncFileSystem, TerminalBackend};
use xai_nemesis_tools::notification::ToolNotificationHandle;
use xai_nemesis_tools::registry::types::SessionContext;
...
/// tool registry in `xai-nemesis-tools` (also used by the hook matcher).
fn claude_tool_kind(name: &str) -> Option<ToolKind> {
    xai_nemesis_tools::types::kind_for(name)
}
...
pub struct AgentBuilder {
    ...
    /// path (e.g., `~/.nemesis/worktrees/project/fork-...-overlay`) that must stay
    ...
    parent_scheduler_handle:
        Option<xai_nemesis_tools::implementations::grok_build::scheduler::types::SchedulerHandle>,
    ...
    memory_backend: Option<Arc<dyn xai_nemesis_tools::types::memory_backend::MemoryBackend>>,
    web_search_config: xai_nemesis_tools::implementations::web_search::WebSearchConfig,
    ...
    lsp: Option<std::sync::Arc<dyn xai_nemesis_tools::implementations::lsp::LspBackend>>,
    ...
    app_builder_deployer_config:
        xai_nemesis_tools::implementations::grok_build::deploy_app::AppBuilderDeployerConfig,
    ...
    compat: xai_nemesis_tools::types::compat::CompatConfig,
    ...
    attribution_callback: Option<xai_nemesis_tools::SharedAttributionCallback>,
    ...
    /// `resolve_max_mcp_output_bytes_for_cwd` in xai-nemesis-shell).
...
fn ensure_plan_mode_tools(tool_config: &mut xai_nemesis_tools::registry::types::ToolServerConfig) {
    use xai_nemesis_tools::implementations::grok_build;
...
fn merge_tool_params(
    tool_config: &mut xai_nemesis_tools::registry::types::ToolServerConfig,
    ids: &[&str],
...
impl AgentBuilder {
    pub fn new(
        ...
        Self {
            ...
            terminal_backend,
            fs_backend: Arc::new(xai_nemesis_tools::computer::local::LocalFs),
            notification_handle,
            ...
            system_reminder_tag: xai_nemesis_tools::reminders::DEFAULT_REMINDER_TAG,
    ...
    pub fn with_preloaded_skills(
        mut self,
        skills: Vec<xai_nemesis_tools::implementations::skills::types::SkillInfo>,
    ) -> Self {
    ...
    pub fn with_memory_backend(
        mut self,
        backend: Arc<dyn xai_nemesis_tools::types::memory_backend::MemoryBackend>,
    ) -> Self {
    ...
    pub fn with_parent_scheduler_handle(
        mut self,
        handle: xai_nemesis_tools::implementations::grok_build::scheduler::types::SchedulerHandle,
    ) -> Self {
    ...
    pub fn with_web_search_config(
        mut self,
        config: xai_nemesis_tools::implementations::web_search::WebSearchConfig,
    ) -> Self {
    ...
    pub fn with_web_fetch_config(
        mut self,
        config: xai_nemesis_tools::implementations::grok_build::web_fetch::WebFetchConfig,
    ) -> Self {
    ...
    pub fn with_lsp(
        mut self,
        handle: std::sync::Arc<dyn xai_nemesis_tools::implementations::lsp::LspBackend>,
    ) -> Self {
    ...
    pub fn with_image_gen_config(
        mut self,
        config: xai_nemesis_tools::implementations::grok_build::image_gen::ImageGenConfig,
    ) -> Self {
    ...
    pub fn with_video_gen_config(
        mut self,
        config: xai_nemesis_tools::implementations::grok_build::video_gen::VideoGenConfig,
    ) -> Self {
    ...
    pub fn with_app_builder_deployer_config(
        mut self,
        config: xai_nemesis_tools::implementations::grok_build::deploy_app::AppBuilderDeployerConfig,
    ) -> Self {
    ...
    pub fn with_api_key_provider(
        mut self,
        provider: xai_nemesis_tools::types::SharedApiKeyProvider,
    ) -> Self {
    ...
    /// Without this, only auto-discovered skills (cwd/.nemesis/skills, ~/.nemesis/skills)
    ...
    pub async fn build(mut self) -> Result<Agent, AgentBuildError> {
        ...
        if definition.inject_default_tools {
            if self.memory_backend.is_some() {
                use xai_nemesis_tools::implementations::memory;
                tool_config
                    .tools
            ...
            if self.lsp.is_some() {
                tool_config
                    .tools
                    .push((&xai_nemesis_tools::implementations::grok_build::LspTool).into());
            }
            if self.image_gen_config.image_gen_enabled() {
                tool_config
                    .tools
                    .push((&xai_nemesis_tools::implementations::grok_build::ImageGenTool).into());
            }
            if self.image_gen_config.image_edit_enabled() {
                tool_config
                    .tools
                    .push((&xai_nemesis_tools::implementations::grok_build::ImageEditTool).into());
            }
            if self.video_gen_config.is_enabled() {
                tool_config
                    .tools
                    .push((&xai_nemesis_tools::implementations::grok_build::ImageToVideoTool).into());
                tool_config.tools.push(
                    (&xai_nemesis_tools::implementations::grok_build::ReferenceToVideoTool).into(),
                );
            }
            ...
            if self.write_file_enabled && !has_write_tool {
                tool_config
                    .tools
                    .push((&xai_nemesis_tools::implementations::opencode::OpenCodeWriteTool).into());
            }
            ensure_plan_mode_tools(&mut tool_config);
        }
        if self.memory_backend.is_none() {
            let grok_build_ns = xai_nemesis_tools::types::tool::ToolNamespace::GrokBuild.to_string();
            let mem_search_id = format!(
                "{grok_build_ns}:{}",
                xai_nemesis_tools::implementations::memory::MEMORY_SEARCH_TOOL_NAME
            );
            let mem_get_id = format!(
                "{grok_build_ns}:{}",
                xai_nemesis_tools::implementations::memory::MEMORY_GET_TOOL_NAME
            );
            tool_config
                .tools
        ...
        if !self.ask_user_question_enabled {
            let ask_user_id = format!(
                "{}:ask_user_question",
                xai_nemesis_tools::types::tool::ToolNamespace::GrokBuild,
            );
        ...
        if task_stripped {
            use xai_nemesis_tools::types::tool::ToolNamespace;
        ...
        if let xai_nemesis_tools::implementations::grok_build::web_fetch::WebFetchConfig::Enabled {
            ref params,
        ...
        if let Some(bytes) = self.mcp_max_output_bytes {
            tool_bridge.toolset().resources.lock().await.insert(
                xai_nemesis_tools::types::resources::TruncationCfg(
                    xai_nemesis_tools::types::context::TruncationConfig {
        ...
        if use_backend_search {
            if web_search_enabled && definition.hosted_tool_allowed("web_search") {
                hosted_tools.push(xai_nemesis_sampling_types::HostedTool::WebSearch {
                    allowed_domains: None,
                });
            }
            if definition.hosted_tool_allowed("x_search") {
                hosted_tools.push(xai_nemesis_sampling_types::HostedTool::XSearch);
            }
        }
...
fn resolve_shell_for_prompt() -> String {
    ...
    #[cfg(not(unix))]
    {
        xai_nemesis_config::shell::detect_windows_shell()
            .name()
            .to_string()
    }
}
...
mod tests {
    ...
    fn entry(name: &str, desc: &str, source: SubagentSource) -> SubagentEntry {
        SubagentEntry {
            ...
            config_source: xai_nemesis_tools::types::config_source::ConfigSource::Builtin,
        }
    }
    #[test]
    ...
    fn build_task_description_shadowed_builtin_uses_user_desc() {
        let subagents = vec![SubagentEntry {
            ...
            config_source: xai_nemesis_tools::types::config_source::ConfigSource::Project {
    ...
    fn build_task_description_lists_public_model_slugs() {
        ...
        assert!(!desc.contains(concat!("nemesis", " models")));
    }
    #[test]
    ...
    fn task_model_guidance_resolves_model_param_override() {
        use xai_nemesis_tools::types::template_renderer::TemplateRenderer;
        use xai_nemesis_tools::types::tool::ToolKind;
    ...
    async fn build_pager_agent(
        ...
        use xai_nemesis_tools::computer::local::LocalTerminalBackend;
        use xai_nemesis_tools::notification::ToolNotificationHandle;
        AgentBuilder::new(
            std::env::temp_dir(),
    ...
    async fn plan_mode_injected_ask_user_question_receives_params() {
        use xai_nemesis_tools::computer::local::LocalTerminalBackend;
        use xai_nemesis_tools::implementations::grok_build::ask_user_question::AskUserQuestionParams;
        use xai_nemesis_tools::notification::ToolNotificationHandle;
        use xai_nemesis_tools::types::resources::Params;
    ...
    async fn spawning_blocked_disables_all_background_bash_modes() {
        use xai_nemesis_tools::computer::local::LocalTerminalBackend;
        use xai_nemesis_tools::implementations::grok_build::bash::BashParams;
        use xai_nemesis_tools::notification::ToolNotificationHandle;
        use xai_nemesis_tools::types::resources::Params;
    ...
    async fn requested_enabled_web_tools_survive_allowlist() {
        use xai_nemesis_tools::computer::local::LocalTerminalBackend;
        use xai_nemesis_tools::implementations::grok_build::web_fetch::WebFetchConfig;
        use xai_nemesis_tools::implementations::web_search::WebSearchConfig;
        use xai_nemesis_tools::notification::ToolNotificationHandle;
        let mut definition = crate::config::AgentDefinition::default_grok_build();
    ...
    async fn disallowed_web_search_strips_function_and_hosted_tools() {
        ...
        assert!(
            !hosted
                .iter()
                .any(|t| matches!(t, xai_nemesis_sampling_types::HostedTool::WebSearch { .. })),
            "hosted WebSearch must be removed when web_search is disallowed, got: {hosted:?}"
        );
        assert!(
            hosted
                .iter()
                .any(|t| matches!(t, xai_nemesis_sampling_types::HostedTool::XSearch)),
