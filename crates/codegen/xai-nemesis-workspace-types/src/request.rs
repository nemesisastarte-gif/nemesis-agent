...
//!   here would force every consumer of `xai-nemesis-workspace-types`
...
//! (`xai-nemesis-workspace`) wraps this in its own `Request<T>` that
//! adds the cancellation token and extensions map.
//!
//! Splitting the envelope this way keeps `xai-nemesis-workspace-types`
