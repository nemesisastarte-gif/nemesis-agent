...
//! `xai_nemesis_shell::session::git` and `xai_nemesis_shell::extensions::git`
...
/// VCS kind.
///
/// TODO(workspace): align with `xai_nemesis_shell::session::git::VcsKind`.
