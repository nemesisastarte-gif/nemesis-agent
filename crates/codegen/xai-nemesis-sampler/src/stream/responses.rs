...
pub fn stream_responses<'a>(
    ...
    async_stream::stream! {
        ...
        let mut items = xai_nemesis_sampling_types::response_to_conversation_items(response);
        xai_nemesis_sampling_types::inject_streaming_reasoning_fallback(&mut items, reasoning_acc);
...
mod tests {
    ...
    async fn doom_loop_collector_signals_land_on_completed_response() {
        use xai_nemesis_sampling_types::doom_loop::{
