...
//! `xai_nemesis_sampling_types::SamplingConfig` so that the sampler crate
//! avoids transitive dependencies on shell-specific types
//! (`xai-nemesis-tools`, etc.).
...
/// submit.
///
/// # Construction in `xai-nemesis-shell`
///
...
/// composing chat-state's `xai_nemesis_sampling_types::SamplingConfig`
