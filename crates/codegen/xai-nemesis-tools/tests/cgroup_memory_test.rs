...
//! cargo test -p xai-nemesis-tools --test cgroup_memory_test -- --ignored --nocapture
//!
//! # If you need root:
//! sudo -E cargo test -p xai-nemesis-tools --test cgroup_memory_test -- --ignored --nocapture
//! ```
//!
...
use xai_nemesis_tools::computer::local::cgroup::{CgroupMemoryConfig, PROCESS_OOM_EXIT_CODE};
use xai_nemesis_tools::computer::types::{TerminalBackend, TerminalRunRequest, TerminalRunResult};
use xai_nemesis_tools::notification::types::ToolNotificationHandle;
