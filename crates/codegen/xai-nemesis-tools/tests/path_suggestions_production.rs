...
//! Run:
//! ```bash
//! cargo test -p xai-nemesis-tools --test path_suggestions_production
//! ```

use std::path::PathBuf;
use tempfile::TempDir;
use xai_nemesis_tools::util::path_suggestions::{format_not_found_error, path_not_found_hint};
...
fn similar_names(hint: &xai_nemesis_tools::util::path_suggestions::PathNotFoundHint) -> Vec<String> {
    hint.similar
        .iter()
