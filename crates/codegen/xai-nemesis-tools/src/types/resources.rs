...
/// tool falls back to `Cwd/.nemesis/plan.md`.
#[derive(Debug, Clone)]
...
pub const PLAN_FILE_RELATIVE_PATH: &str = ".nemesis/plan.md";
...
/// [`Cwd`]`/.nemesis/plan.md`, else the bare relative `.nemesis/plan.md`.
...
/// depending on `xai-nemesis-mcp` directly.  Follows the same pattern as
