...
use xai_nemesis_shell::tools::TodoStatus;
    ...
    let mut lines: Vec<Line<'static>> = todos
        ...
        .map(|t| {
            let (glyph, style) = match t.status {
                ...
                TodoStatus::Completed => (xai_nemesis_pager::glyphs::check_mark(), theme.muted()),
                TodoStatus::Cancelled => (
                    xai_nemesis_pager::glyphs::ballot_x(),
...
mod tests {
    ...
    use xai_nemesis_shell::tools::{TodoItem, TodoPriority};
