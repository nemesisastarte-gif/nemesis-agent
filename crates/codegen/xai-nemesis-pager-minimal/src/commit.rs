...
use xai_nemesis_pager::appearance::AppearanceConfig;
...
use xai_nemesis_pager::scrollback::blocks::ToolCallBlock;
use xai_nemesis_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn btw_block_emits_once_across_repeated_frontier_passes() {
        ...
        s.push(ScrollbackEntry::new(RenderBlock::Btw(
            xai_nemesis_pager::scrollback::blocks::BtwBlock::new(
                "original question",
                "original answer",
            ),
        )));
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use ratatui::buffer::Buffer;
        use xai_nemesis_pager::theme::cache as theme_cache;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                xai_nemesis_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
        ...
        let hunk = vec![
            xai_nemesis_pager::diff::DiffLine {
                text: "let x = 1;\n".into(),
                lo: 1,
                ln: 1,
                tag: ChangeTag::Equal,
    ...
    fn committed_edit_keeps_diff_line_backgrounds() {
        ...
        use ratatui::layout::Rect;
        use similar::ChangeTag;
        use xai_nemesis_pager::diff::DiffLine;
    ...
    fn commit_display_mode_lookups_collapse_on_success_only() {
        use xai_nemesis_pager::scrollback::blocks::{
