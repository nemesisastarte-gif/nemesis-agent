pub mod changelog;
pub mod event_id;
pub mod nemesis_home;
pub mod secure_file;
pub mod tips;
pub mod uname;
pub use xai_nemesis_shared::clipboard;
pub use xai_nemesis_shared::stderr::{stderr_lock, with_locked_stderr};
...
pub fn is_grok_process(pid: u32) -> bool {
    #[cfg(target_os = "linux")]
    {
        ...
        match std::fs::read(&cmdline_path) {
            Ok(data) => String::from_utf8_lossy(&data).contains("nemesis"),
            Err(_) => false,
        }
    }
    #[cfg(windows)]
